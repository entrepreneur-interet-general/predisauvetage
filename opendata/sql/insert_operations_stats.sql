...
select
  ...
  round(coalesce(m.duree_engagement_moyens_nautiques_minutes, 0)/60, 2) duree_engagement_moyens_nautiques_heures,
  round(coalesce(m.duree_engagement_moyens_terrestres_minutes, 0)/60, 2) duree_engagement_moyens_terrestres_heures,
  round(coalesce(m.duree_engagement_moyens_aeriens_minutes, 0)/60, 2) duree_engagement_moyens_aeriens_heures,
