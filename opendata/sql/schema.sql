...
CREATE TABLE public.operations_stats (
    ...
    "duree_engagement_moyens_nautiques_heures" numeric(6, 2) not null,
    "duree_engagement_moyens_terrestres_heures" numeric(6, 2) not null,
    "duree_engagement_moyens_aeriens_heures" numeric(6, 2) not null,
